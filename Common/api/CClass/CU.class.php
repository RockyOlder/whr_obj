...
// // var_dump(dirname($class));
//  define( "CU_ROOT",str_replace('\\','/',dirname($class))."/" );
//       // dump(CU_ROOT);
//   define( "CU_CLASS_PATH", CU_ROOT."CClass/" );
//   define( "CU_COMM_PATH", CU_ROOT."comm/" );
//   define( "CU_DATA_PATH", CU_ROOT."data/" );  
// require_once( CU_COMM_PATH."utils.php");
// require_once( CU_CLASS_PATH."Token.class.php");
// require_once( CU_CLASS_PATH."MyHttp.class.php");
