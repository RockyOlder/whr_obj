  ...
  public $tem=array();
    ...
    public function carInfo(){
        ...
        if ($id == 1) {
            ...
            $field ="id,title,content,pic,author,add_time,start_time,pass_time,views,phone,uid,address,number";
    ...
    public function property(){
      ...
      // dump($data);
        ...
        if ($id == 1) {
            ...
            $son = M($table)->field($field)->where(array('pid'=>$data['id']))->order('time asc')->select();
            if (!$son) {
              $son = array();
            }else{
              foreach ($son as $k => $v) {
