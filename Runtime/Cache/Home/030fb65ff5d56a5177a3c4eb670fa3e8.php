                        ...
                        <input type ="hidden" name="id" value="<?php echo ($info["id"]); ?>">
                            <input type ="hidden" name="action" value="<?php echo ($data["action"]); ?>">
                                <input type ="hidden" name="admin" value=<?php echo ($_SESSION['admin']['name']); ?>>
                                    <input type="hidden" value="<?php echo ($info["is_all"]); ?>" id="if_show">
                                        <div class="formbody">
                                            <div class="formtitle"><span><?php echo ($data["title"]); ?></span></div>
                                            <ul class="forminfo">
                                                <li><label>标题</label><input name="title" type="text" class="dfinput" id="titleEmpty" value="<?php echo ($info["title"]); ?>" /><i>标题不能超过6字</i></li>
                                                <li><label>地址</label>
                                                    <span class = 'pro'>
                                                        ...
                                                        <select name = 'city' style="display:none" id ="city_list" class="form-control" <!--onclick="saveCity()" -->>
                                                                <option class = "city_in" value="<?php echo ($info["range"]); ?>"></option>
                                                        </select>
                                                ...
                                                <li><label>开始时间</label><input readonly="readonly" name="add_time"  type="text"  class="dfinputInfo" id="d412" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="<?php echo ($info["add_time"]); ?>" /><i class="errorColor">开始时间不能为空</i></li>
                                                <li><label>结束时间</label><input readonly="readonly" name="deadline" type="text" class="dfinputInfo" id="d413" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="<?php echo ($info["deadline"]); ?>" /><i class="errorColor">结束时间不能为空</i></li>
                                                <li><label>推荐表述</label><textarea rows="5"  cols='50' style="border:1px solid #A7B5BC" name ="info"  id="info" value="<?php echo ($info["info"]); ?>"><?php echo ($info["info"]); ?></textarea><i>描述</i></li>
                                                <li><label>全国推荐</label><input name="is_all"  class="radiolist" id="rdaoid"  type="radio" value="1"><a class="box">是</a><input name="is_all"  class="radiolist" type="radio" value="0"><a class="box">否</a></li>
                                                            <li><label>排序</label><input name="sort" type="text" class="dfinput" id="sort" value="<?php echo ($info["sort"]); ?>" /><i></i></li>
