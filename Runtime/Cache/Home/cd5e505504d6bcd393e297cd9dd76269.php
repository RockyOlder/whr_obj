...
<body style="background: none;">
  <input type="hidden" value="/server.php?s=/Home/Admin/del/id/" id="url_ajaxCalendar" name="url_ajaxCalendar" />
        <div class="place">
           <span>位置： </span>
            <ul class="placeul">
            ...
            <div class="tools">
                <form action="" method="post" name="vform" id="vform">
                        <ul>
                            ...
                            <a href="<?php echo U('add');?>"><li class="click"><span><img src="/App/Home/View/Public/Images/t01.png" /></span>添加管理员</li></a>
                        </ul>
                    </form>
            </div>
