    ...
    <form action="" method="post" name="validateForm1">
        ...
        <div class="formbody">
                ...
                <ul class="forminfo">
                    ...
                    <li><label>手机</label><input name="mobile" type="text" class="dfinput"  value="<?php echo ($info["mobile"]); ?>"/><i></i></li>
                    ...
                    <li style="position: relative;"><label>选择物业</label>
                        <span class = 'pro'>
                            <select name = 'property' id="property" reg="[^0]" tip="请选择物业" class="form-control" >
                                ...
                                <?php if(is_array($property)): $i = 0; $__LIST__ = $property;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option class = "top_cate" value="<?php echo ($vo["id"]); ?>"  selected="selected"><?php echo ($vo["pname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </span>
