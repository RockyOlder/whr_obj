...
<div class="loginbody">
    ...
    <div class="loginbox">
        ...
        <?php if($_SESSION['num']== 1): ?><li><input name="verify" type="text" class = "verify" value="验证码" onclick="JavaScript:this.value=''" />
            	<img src="<?php echo U('verify','','');?>" style="width:150px;height:48px" onclick="this.src=this.src+'&'+Math.random(0,9999)"  id='verifyImg'><span id ="verify_info"></span></li><?php endif; ?>
        <li><input name="" type="button" class="loginbtn" value="登录"  onclick="checklogin()"   /><!-- <label><input name="remeber" type="checkbox" value="1" checked="checked" />记住密码</label> --><label><a href="<?php echo U('Passwd/index');?>">忘记密码？</a></label><label><a href="http://master.huishare.com/mobile.php?s=life/register" >立即申请</a></label></li>
        </ul>
