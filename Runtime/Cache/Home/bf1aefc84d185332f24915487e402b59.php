            ...
            <link rel="stylesheet" type="text/css" href="/App/Home/View/Public/Css/bootstrap.min.css">
                ...
                function goods_Shop(id) {
                    ...
                    function(){
                        var msg = art.dialog({id:'bnt4_test'}).data.content; // 使用内置接口获取消息容器对象
                        if(msg){
                            location.href=$("#url_Save_id").val()+id
                            return false;
                        }        
                    },function(){
                        return true;
                ...
                <body style="background: none;">
                    <input type="hidden" value="/index.php?s=/Home/VipRecom/del/id/" id="url_ajaxCalendar" name="url_ajaxCalendar" />
                          <input type="hidden" value="/index.php?s=/Home/VipRecom/vdel/id/" id="url_Save_id" />
                             <input type="hidden" value="/index.php?s=/Home/VipRecom/vdel/vid/" id="url_ajaxVid" />
                    <div class="place">
                        <span>位置： </span>
                        <ul class="placeul">
                    ...
                    <div class="rightinfo">
                        ...
                        <table class="tablelist">
                            ...
                            <tbody id="table_ajax_list">
                                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr  id = "<?php echo ($vo["id"]); ?>">
                                        ...
                                        <td width="20px" class="th_default" align="center"><a href="<?php echo U('RecormObjectSaveVip',array(id=>$vo['id']),'');?>" class="divBtn editBtn ui-state-default ui-corner-all" title="编辑" ><span class="ui-icon ui-icon-pencil"></span></a></td>
                                        <?php if($vo["type"] == 1): ?><td width="20px" class="th_default" align="center"><div class="divBtn deleteBtn ui-state-default ui-corner-all" title="设置为推荐"onclick="return goods_Shop(<?php echo ($vo["id"]); ?>)"><span class="ui-icon ui-icon-star"></span></div></td><?php endif; ?>
                                        <?php if($vo["type"] == 2): ?><td width="20px" class="th_default" align="center"><div class="divBtn deleteBtn ui-state-default ui-corner-all" title="设置为热卖"onclick="return vip_Shop(<?php echo ($vo["id"]); ?>)"><span class="ui-icon ui-icon-heart"></span></div></td><?php endif; ?>
                        ...
                        <div class="tip">
                            ...
                            <div class="tipbtn">
                                ...
                                <input type="hidden" value="<?php echo U('ajax_del_goods');?>" id="delete"/>
                            </div>
                        </div>
                    </div>
