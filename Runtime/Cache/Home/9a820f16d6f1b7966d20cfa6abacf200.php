                    ...
                    <body style="background: none;">
                        ...
                        <div class="place">
                            ...
                            <ul class="placeul">
                                ...
                                <li><a href="/index.php?s=/Home/Ad">广告列表</a></li>
                                <li>添加/修改广告</li>
                            </ul>
                        </div>
                            ...
                            <input type ="hidden" name="ad_id" value="<?php echo ($info["ad_id"]); ?>">
                                <input type ="hidden" name="action" value="<?php echo ($data["action"]); ?>">
                                    <input type ="hidden" name="admin" value=<?php echo ($_SESSION['admin']['name']); ?>>
                                        <input type="hidden" value="<?php echo ($info["type"]); ?>" id="if_show"> 
                                            <div class="formbody">
                                                ...
                                                <ul class="forminfo">
                                                    ...
                                                    <li><label>所属类型</label>
                                                        <input  class="radiolist"  name="type"type="radio" value="1"  checked="checked" />生活导航&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <input  class="radiolist"  name="type"type="radio" value="2"  />vip特享&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <input  class="radiolist"  name="type"type="radio" value="3" />家园<i id="type_info"></i></li>
                                                    <li><label>图片</label>
                                                        <div id="list_hidden">
                                                                                                ...
                                                                                                <script>
                                                                                                    $(document).ready(function() {
                                                                                                        $('.radiolist').each(function() {
                                                                                                            ...
                                                                                                            }else if($("#if_show").val()==2 && $(this).val()==2){
                                                                                                                $(this).attr({ checked: "checked"})
                                                                                                            }else if($("#if_show").val()==3 && $(this).val()==3){
                                                                                                                $(this).attr({ checked: "checked"})
                                                                                                            }
                                                                                                        });
