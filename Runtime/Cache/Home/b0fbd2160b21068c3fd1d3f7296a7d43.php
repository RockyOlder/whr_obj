                        ...
                        <table class="tablelist">
                            ...
                            <tbody id="table_ajax_list">
                                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr  id = "<?php echo ($vo["id"]); ?>">
                                        ...
                                        <td width="20px" class="th_default" align="center"><a href="<?php echo U('recommendedGoods',array(id=>$vo['id']),'');?>" class="divBtn editBtn ui-state-default ui-corner-all" title="编辑" ><span class="ui-icon ui-icon-pencil"></span></a></td>
