...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body style="background: none;">
        ...
        <input type="hidden" value="/default/index.php?s=/Home/Order/order" id="examUpdate" name="examUpdate" />
        <input type="hidden" value="/default/index.php?s=/Home/Order/urlAjaxOrderFind" id="url_ajaxCalendar" name="url_ajaxCalendar" />
        <input type="hidden" value="/default/index.php?s=/Home/Order/urlAjaxOrderVipFind" id="urlAjaxOrderVipFind" />
