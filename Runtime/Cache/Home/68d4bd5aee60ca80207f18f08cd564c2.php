        ...
        <link rel="stylesheet" type="text/css" href="/App/Home/View/Public/Js/jquery-ui/css/pepper-grinder/jquery-ui.min.css">
            ...
            <link rel="stylesheet" type="text/css" href="/App/Home/View/Public/Css/bootstrap.min.css">
                ...
                <style>
                    ...
                    .th_default_CX{ width: 60px; }
                    .th_default_CX div{ height: 30px; }
                ...
                <body style="background: none;">
                    <input type="hidden" value="/index.php?s=/Home/Seller/details" id="url_getTeacher" name="url_getTeacher" />
                    <input type="hidden" value="/index.php?s=/Home/Seller/del/id/" id="url_ajaxCalendar" name="url_ajaxCalendar" />
                    <div class="place">
                        <span>位置： </span>
                        <ul class="placeul">
                            ...
                            <table class="imgtable">
                                ...
                                <tbody>
                                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <?php if($vo["num"] == 0): ?><td width="20px" class="th_default" align="center"><a href="<?php echo U('activity',array(id=>$vo['goods_id']),'');?>" class="divBtn editBtn ui-state-default ui-corner-all" title="促销商品" ><span class="ui-icon ui-icon-shop"></span></a></td><?php endif; ?>
                                            <?php if($vo["num"] != 0): ?><td width="60px;" align="center"><div  title="正在促销" >正在促销</div></td><?php endif; ?>

                                            <?php if($vo["vip_num"] == 0): ?><td width="20px" class="th_default" align="center"> <a href="<?php echo U('RecormObjectSaveVip',array(id=>$vo['goods_id']),'');?>" class="divBtn editBtn ui-state-default ui-corner-all" title="推荐商品" ><span class="ui-icon ui-icon-shop"></span></a></td><?php endif; ?>
                                            <?php if($vo["vip_num"] != 0): ?><td width="60px;" align="center"><div  title="正在推荐" >正在推荐</div></td><?php endif; ?>
