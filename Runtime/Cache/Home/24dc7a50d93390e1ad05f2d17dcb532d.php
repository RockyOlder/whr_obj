...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body style="background: none;">
        ...
        <input type="hidden" value="/life.php?s=/Home/Business/order" id="examUpdate" name="examUpdate" />
        <input type="hidden" value="/life.php?s=/Home/Business/orderDel" id="orderDEL"  />
        <input type="hidden" value="/life.php?s=/Home/Business/urlAjaxOrderFind" id="url_ajaxCalendar" name="url_ajaxCalendar" />
        <input type="hidden" value="/life.php?s=/Home/Business/urlAjaxOrderVipFind" id="urlAjaxOrderVipFind" />
