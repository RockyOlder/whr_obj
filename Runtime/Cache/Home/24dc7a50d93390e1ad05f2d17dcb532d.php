...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body style="background: none;">
        ...
        <input type="hidden" value="/whr/index.php?s=/Home/Business/repair" id="examUpdate" name="examUpdate" />
        <input type="hidden" value="/whr/index.php?s=/Home/Business/urlAjaxOrderFind" id="url_ajaxCalendar" name="url_ajaxCalendar" />
