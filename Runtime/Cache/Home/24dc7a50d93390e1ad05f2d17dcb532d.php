...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body style="background: none;">
        ...
        <input type="hidden" value="/default/index.php?s=/Home/Business/order" id="examUpdate" name="examUpdate" />
        <input type="hidden" value="/default/index.php?s=/Home/Business/urlAjaxOrderFind" id="url_ajaxCalendar" name="url_ajaxCalendar" />
        <input type="hidden" value="/default/index.php?s=/Home/Business/urlAjaxOrderVipFind" id="urlAjaxOrderVipFind" />
        ...
        <table class="tablelist">
            ...
            <tbody id="table_ajax_list">
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="role-list"><button class="btn btn-default" type="button" onclick="update_list(<?php echo ($vo["oid"]); ?>,<?php echo ($vo["cate"]); ?>)"><?php echo ($vo["statue"]); ?></button></td> 
                        <td class="th_default">    
                            ...
                            <a id="done_add" class="btn btn-default"   onclick="rule_add(<?php echo ($vo["oid"]); ?>,<?php echo ($vo["cate"]); ?>)">详情</a>
                        </td>
