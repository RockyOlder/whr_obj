                                ...
                                <input type ="hidden" name="admin" value=<?php echo ($_SESSION['admin']['name']); ?>>
                                    <div class="formbody">
                                        ...
                                        <ul class="forminfo">
                                           ...
                                           <li><label>商品名字</label><input name="name" id="name" type="text" class="dfinput" value="<?php echo ($info["goods_name"]); ?>" disabled="disabled" /><i id="name_info">名称不能超过30个字符</i></li>
                                            <li><label>推荐标题</label><input name="title" type="text" class="dfinput"  value="<?php echo ($info["title"]); ?>" /><i>推荐标题</i></li>
                                            <li style="height:85px"><label>推荐描述</label><textarea rows="5"  cols='50' style="border:1px solid #A7B5BC; width: 345px;" id="description" name ="info" value="<?php echo ($info["description"]); ?>"><?php echo ($info["description"]); ?></textarea><i>描述</i></li>
                                            <li><label>排序</label><input name="sort" type="text" class="dfinput"  /><i>作用于前台排序</i></li>
                                            <li><label>图片</label>
                                                <div id="list_hidden">
