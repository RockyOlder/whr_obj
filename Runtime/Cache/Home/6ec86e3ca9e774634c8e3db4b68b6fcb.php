...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body style="background: none;">
        ...
        <input type="hidden" value="/vip.php?s=/Home/Vip/order" id="examUpdate" name="examUpdate" />
        <input type="hidden" value="/vip.php?s=/Home/Vip/orderDel" id="orderDEL"  />
        <input type="hidden" value="/vip.php?s=/Home/Vip/urlAjaxOrderFind" id="url_ajaxCalendar" name="url_ajaxCalendar" />
            ...
            <table class="tablelist">
                ...
                <tbody id="table_ajax_list">
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td class="th_default">    
                                <!--  <a class="btn btn-default" onclick="update_list(<?php echo ($vo["rid"]); ?>)">修改</a>  发货 <?php echo U('del',array(id=>$vo['oid']),'');?>  -->
                                <a id="delete_Order" class="btn btn-default" onclick="rule_delete(<?php echo ($vo["oid"]); ?>)"> 删除</a>
                                <a href="<?php echo U('order',array(fid=>$vo['oid']),'');?>" class="btn btn-default" >详情</a>
                                <?php if( $vo["statue"] =='未付款'): ?><button class="btn btn-default" type="button" onclick="update_list(<?php echo ($vo["oid"]); ?>)">修改运费</button><?php endif; ?>  
