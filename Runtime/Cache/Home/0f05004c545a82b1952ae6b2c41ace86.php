...
<head>
	...
	<style type="text/css">
        ...
        #info2 ul li{height: 80px;width: 40%;float: left;text-indent: 2em;overflow: hidden;}
...
<body style="background: #FFFFFF;">
	<div class="place">
        ...
        <ul class="placeul">
            ...
            <li>商家管理</li>
            <li><a href="<?php echo U('SellerApp/life');?>">服务商家申请列表</a></li>
		...
		<div>
			...
			<div class="title">
				...
				<div id="info2">
            		...
            		<li><span>店面图片：</span><img src="<?php echo ($shop["list_pic"]); ?>" alt="店面图片" width="50" /></li>
                    <li><span>详细图片：</span>
                    	<?php if(is_array($shop[more_pic])): $i = 0; $__LIST__ = $shop[more_pic];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s): $mod = ($i % 2 );++$i;?><img src="<?php echo ($s["mid"]); ?>" alt="<?php echo ($s["name"]); ?>" width="50" /><?php endforeach; endif; else: echo "" ;endif; ?>
                    </li>
