...
<body style="background: none;">
    ...
    <div class="tools">
       ...
       <form action="" method="post" name="vform" id="vform">
            <ul>
                ...
                <li><span><img src="/whr/App/Home/View/Public/Images/ico06.png" width="25"/>查找</span></li>
                <!-- <li></li> -->
            </ul>
       </form>
    ...
    <table class="tablelist">
        ...
        <td> 
            <a href="<?php echo U('add',array(id=>$vo['id'],pid=>$vo['pid']),'');?>" class="tablelink">修改</a>    
            <a href="<?php echo U('del',array(id=>$vo['id'],pid=>$vo['pid']),'');?>" class="tablelink"> 删除</a>
        </td>
