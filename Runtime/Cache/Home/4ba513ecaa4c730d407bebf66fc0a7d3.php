                                            ...
                                            <li><label>选择活动</label>
                                                <span class = 'pro'>
                                                    <select name ='aid' id="type_on" class="form-control" >
                                                        <option class = "top_cate" value="<?php echo ($save["id"]); ?>" name="aid" ><?php echo ($save["title"]); ?></option>
                                                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option class = "top_cate" value="<?php echo ($vo["id"]); ?>" name="aid" ><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                    </select>
                                                </span>

                                                <i id="name_info">名称不能超过30个字符</i></li>
                                            <li><label>商品名字</label><input name="good_name" id="name" type="text" class="dfinput" value="<?php echo ($info["good_name"]); ?>" /><i id="name_info">名称不能超过30个字符</i></li>
                                            <li><label>原价</label><input name="o_price" type="text" class="dfinput"  value="<?php echo ($info["o_price"]); ?>" disabled="disabled" /><i>商品价格</i></li>
                                            <li><label>活动价格</label><input name="price" type="text" class="dfinput" value="<?php echo ($info["price"]); ?>" /><i></i></li>
                                            <li><label>竞价</label><input name="sort" type="text" class="dfinput" value="<?php echo ($info["sort"]); ?>" /><i></i></li>
                                            <li><label>图片</label>
                                                <div id="list_hidden">
