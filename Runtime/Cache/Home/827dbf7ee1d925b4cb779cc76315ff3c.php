                        ...
                        <table class="tablelist">
                            ...
                            <tbody id="table_ajax_list">
                                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td>
                                            <a href="<?php echo U('add',array(id=>$vo['ad_id']),'');?>" class="tablelink">修改</a>  <!--  href="<?php echo U('del',array(id=>$vo['id']),'');?>" onclick="if(confirm('确认删除')){return true}else{return false}" -->

                                            <a  class="tablelink" class="love_obj" onclick="return cats_Shop(<?php echo ($vo["ad_id"]); ?>)" > 删除</a>
                                        </td>
