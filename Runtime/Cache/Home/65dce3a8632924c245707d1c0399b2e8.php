        ...
        <div class="start">
            <div class="little">
                <a href="<?php echo U('Vip/vlist');?>">
                    <img class="background" src="/default/App/Home/View/Public/Images/start/vip.png"width="100px" height="100px">
            ...
            <div class="little"> 
                ...
                <a href="<?php echo U('Business/index');?>">
                    <img class="background" src="/default/App/Home/View/Public/Images/start/life.png"width="100px" height="100px;">
            ...
            <div class="little">    
                ...
                <a href="<?php echo U('Developer/index');?>">
                    <img class="background" src="/default/App/Home/View/Public/Images/start/house.png"width="100px" height="100px">
        ...
        <div class="start">
            ...
            <div class="little"> 
                <a href="<?php echo U('User/index');?>">
                    <img class="background" src="/default/App/Home/View/Public/Images/start/user.png"width="100px" height="100px">
                    <p class="text"><span>会员列表</span></p>
                </a>
            </div>
            <div class="little"> 
                <a href="<?php echo U('Message/index');?>">
                    <img class="background" src="/default/App/Home/View/Public/Images/start/push.png"width="100px" height="100px">
                    <p class="text"><span>推送列表</span></p>
                </a>
            </div>
            <div class="little"> 
                <a href="<?php echo U('Activity/add');?>">
                    <img class="background" src="/default/App/Home/View/Public/Images/start/action.png"width="100px" height="100px">
        ...
        <div class="start">
            ...
            <div class="little"> 
                <a href="<?php echo U('Month/index');?>">
                    <img class="background" src="/default/App/Home/View/Public/Images/start/sum.png"width="100px" height="100px">
