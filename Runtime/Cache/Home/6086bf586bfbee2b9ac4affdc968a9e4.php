...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body style="background: none;">
        <input type="hidden" value="/whr/index.php?s=/Home/Config/details" id="url_getTeacher" name="url_getTeacher" />
        <input type="hidden" value="/whr/index.php?s=/Home/Config/add" id="url_add" name="url_getTeacher" />
        <div class="place">
            <span>位置：</span>
            <ul class="placeul">
                <li><a href="#">首页</a></li>
