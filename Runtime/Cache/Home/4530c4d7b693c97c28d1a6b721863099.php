...
<div class="loginbody">
    ...
    <div class="systemlogo">
        ...
        <span class="box_title">慧享园-VIP商家登录系统</span>
    </div> 
    ...
    <div class="loginbox">
        ...
        <li><input name="" type="submit" class="loginbtn" value="登录"  onclick="javascript:;"  /><!-- <label><input name="remeber" type="checkbox" value="1" checked="checked" />记住密码</label> --><label><a href="<?php echo U('Passwd/index');?>">忘记密码？</a></label><label><a href="http://master.huishare.com/mobile.php?s=vip/register" >立即申请</a></label></li>
        </ul>
        
        </form> 
    </div>
    <div class="login_img">
        <img src="/App/Home/View/Public/Images/login_vip.png">
    </div>
