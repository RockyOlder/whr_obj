...
<div class="loginbody">
    ...
    <div class="loginbox">
        ...
        <li><input name="" type="button" class="loginbtn" value="登录"  onclick="checklogin()"  /><!-- <label><input name="remeber" type="checkbox" value="1" checked="checked" />记住密码</label> --><label><a href="<?php echo U('Passwd/index');?>">忘记密码？</a></label><label><a href="http://master.huishare.com/mobile.php?s=vip/register" >立即申请</a></label></li>
        </ul>
