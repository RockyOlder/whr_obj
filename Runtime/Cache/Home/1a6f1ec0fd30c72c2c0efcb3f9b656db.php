...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <!-- <link href="/default/App/Home/View/Public/Css/select.css" rel="stylesheet" type="text/css" />        <script type="text/javascript" src="/default/App/Home/View/Public/Js/jquery-1.8.3.min.js"></script>      -->
        ...
        <link rel="stylesheet" type="text/css" href="/default/App/Home/View/Public/Css/bootstrap.min.css">
            ...
            <link rel="stylesheet" href="/default/App/Home/View/Public/Css/uploadify.css">
                ...
                <body style="background: none;">
                    ...
                    <input type="hidden" value="/default/index.php?s=/Home/ProInfo/active" id="examUpdate" name="examUpdate" />
                    <input type="hidden" value="<?php echo ($data["table"]); ?>" id="table" name="examUpdate" />
                    <input type="hidden" value="/default/index.php?s=/Home/ProInfo/url_ajaxActive" id="url_ajaxCalendar" name="url_ajaxCalendar" />
                    ...
                    <table class="tablelist">
                        ...
                        <tbody id="table_ajax_list">
                            <?php if(is_array($pro)): $i = 0; $__LIST__ = $pro;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td class="th_default">    
                                    <!--    <a class="btn btn-default" title="编辑" onclick="update_list(<?php echo ($vo["id"]); ?>)">修改</a>   onclick="update_list(<?php echo ($vo["id"]); ?>)"  -->
                                   <a href="<?php echo U('active',array(id=>$vo['id']),'');?>" class="btn btn-default" title="编辑">详情</a>     
