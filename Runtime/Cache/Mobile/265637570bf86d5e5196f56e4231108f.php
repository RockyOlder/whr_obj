...
<html lang="en">
    <head>
        ...
        <link href="/whr_obj/Mobile/View/Public/css/tableList.css" rel="stylesheet" type="text/css" />
        <link rel="stylesheet" type="text/css" href="/whr_obj/Mobile/View/Public/js/jquery-ui/css/pepper-grinder/jquery-ui.min.css">
        <script src="//code.jquery.com/jquery-1.10.2.min.js"></script>
        <script type="text/javascript" src="/whr_obj/Mobile/View/Public/js/common.js"></script>
        <script type="text/javascript" src="/whr_obj/Mobile/View/Public/js/jquery-ui/js/jquery-ui-1.10.4.custom.js"></script>
        ...
        <style>
            ...
            .star{position:relative;height:24px; margin-top: -20px;margin-left: 53px;width: 95px;}
            #pageTwo{ }
            .star .huixing{width: 95px;background: url(/whr_obj/Mobile/View/Public/images/star.png) ;height: 20px;}
            .star .yellowstar{width: 95px;background: url(/whr_obj/Mobile/View/Public/images/star.png) 0  19px ;height: 20px;position: absolute;top: 0px;left: 0px ;}
