...
<title>无标题文档</title>
<style>
.menuset{ width:900px; margin:0 auto; padding:25px 15px 15px 15px;background:url(/whr_obj/Mobile/View/Public/images/ab--.png) center 70px no-repeat;}
ul{list-style:none;}
...
<div class="menuset">
  <ul class="menu">
  <li ><a href="#"><img src="/whr_obj/Mobile/View/Public/images/t1.png" width="30" height="30" style=" float:left; margin-top:-7px; padding-right:5px;">设置登录名</a></li>
  ...
  <li class="bg"><a href="#"><img src="/whr_obj/Mobile/View/Public/images/gou.png" width="30" height="30" style=" float:left; margin-top:-7px; padding-right:5px;">注册成功</a></li>
 </ul>
 </div>
  <div style="text-align:center;font-size:20px ;margin-bottom:50px;font-style:font-style: italic;">管理员注册成功，等待审核通过你就可以做相应的操作了</div>
<div class="conten">
 
<div class="content-s">
<div class="con-s">
<h2>恭喜成功注册为慧享园的物业管理员，你的账号为：</h2>
...
<div style="text-align:center;font-size:20px ;position: fixed;bottom: 30px;left: 100px;font-style:font-style: italic;"><?php echo (C("web_copy")); ?></div>
</body>
</html>