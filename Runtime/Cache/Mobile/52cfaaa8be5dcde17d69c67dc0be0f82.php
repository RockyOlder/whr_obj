...
<script src="/Mobile/View/Public/js/jquery-1.4.2.min.js"></script>
...
.menuset{ width:100%; margin:0 auto; padding:25px 15px 15px 15px;background:url(/Mobile/View/Public/images/ab--.png) center 70px no-repeat;}
ul{list-style:none;}
...
<div class="menuset">
  <ul class="menu">
  <li class="bg"><a href="#"><img src="/Mobile/View/Public/images/tit1.png" width="30" height="30" style=" float:left; margin-top:-7px; padding-right:5px;">设置登录名</a></li>
 ...
 <div style="text-align:center;font-size:25px ;">慧享园的vip合作商家注册页面</div>
<div class="conten">
...
<form action="" method="post" >
  ...
  <div class="username"><span>您的昵称：</span><input name="true_name" type="text"  id="flightno" reg=""  tip="管理系统中显示的名字"/><p style="color:#666; float:right">*此管理系统中显示的名字</p></div>
  <div class="email">
