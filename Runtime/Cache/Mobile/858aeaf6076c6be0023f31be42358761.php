...
<link href="/whr_obj/Mobile/View/Public/css/style.css" rel="stylesheet" type="text/css">
<script src="/whr_obj/Mobile/View/Public/jquery-1.8.0.min.js"></script>
<script src="/whr_obj/Mobile/View/Public/js/easy_validator.pack.js"></script>
<script type="text/javascript" src='/whr_obj/Mobile/View/Public/js/jquery.uploadify.min.js'></script>
<link rel="stylesheet" href="/whr_obj/Mobile/View/Public/css/uploadify.css">
<style type="text/css">
...
<div class="menuset">
  ...
  <li class="bg"><a href="#"><img src="/whr_obj/Mobile/View/Public/images/tit2.png" width="30" height="30" style=" float:left; margin-top:-7px; padding-right:5px;">填写信息</a></li>
...
<div class="content">
  ...
  <input name="name" type="text"  value=""  id="flightno" reg="\S+" tip=" 商家名称 如: 中粮地产" url="<?php echo U('ajax_check_vip','','');?>"  class='padding'>
