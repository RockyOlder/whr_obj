...
<head>
	<meta charset="utf-8">
	<!-- <link href="/wrt/Api/View/index.css" rel="stylesheet" type="text/css"> -->
	<!-- // <script type="text/javascript" src="http://code.jquery.com/jquery-2.0.0.min.js"></script> -->
	<script type="text/javascript" src="/wrt/Api/View/jquery.js"></script>
</head>
<body style="width:60%;margin:50px auto;background:#eee">
	...
	<div class="parms_div">
		...
		<?php $i = 1 ?>
		<?php foreach ($data['api'] as $key => $value): ?>
		<span id="des<?php echo $i ?>" style="display:none"><?php echo $value['des'] ?></span>
		<?php  $i++ ?>
		<?php endforeach ?>
		</div>
		<br/>
	...
	<div class="parms_div">
		...
		<select id="serverUrl" autocomplete="off">
			<option value="/wrt/api.php" selected>当前域名</option>
